...
from dashboard.views import DashboardViewSet, AllDataSummary, LineChartData, PieChartData, UniqueData, YearSummary
...
urlpatterns = [
    ...
    path("unique/", UniqueData.as_view(), name="unique data")
]
